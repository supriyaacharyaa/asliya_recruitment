...
//   // Derive active page from actual URL path, not click state
//   const getActivePage = () => {
...
//   // Measure cert bar height on mount and resize
//   useEffect(() => {
//     const measure = () => {
...
//   // Keep active state in sync when URL changes (e.g. browser back/forward)
//   useEffect(() => {
//     const onLocationChange = () => setActivePage(getActivePage());
...
//   // Total offset for elements below the fixed header stack
//   const totalHeaderHeight = certBarHeight + navbarHeight;

//   return (
//     <>
//       {/* ── Spacer: pushes page content below the fixed header stack ── */}
//       <div style={{ height: totalHeaderHeight }} aria-hidden="true" />

//       {/* ── Fixed header wrapper — stacks cert bar + navbar flush ── */}
//       <div className="fixed top-0 left-0 right-0 z-50 flex flex-col">

//         {/* 1. Top accent line */}
//         {/* <div className="h-[3px] bg-gradient-to-r from-[#0d3270] via-[#154895] to-[#3b7ce8] flex-shrink-0" /> */}
...
//           Licensed by Ministry of Labor Qatar
//         </span>
...
//         {/* 3. Main Navbar — flush directly below cert bar */}
//         <motion.header
//           ref={navbarRef}
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
...
//             {/* Drawer — positioned just below the full fixed header */}
//             <motion.div
...
//                       <a
//                         href={link.href}
//                         onClick={() => { setTimeout(() => setActivePage(getActivePage()), 0); setMobileOpen(false); }}
    ...
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex flex-col">
        ...
        >
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10">
            <div className="flex flex-col sm:flex-row items-center justify-between py-[6px] sm:py-[7px] gap-y-[2px]">
              <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-5 text-[11px] sm:text-[12px] font-semibold text-gray-600">
                <span className="flex items-center gap-1">
                  <span className="text-[#154895] font-bold">✓</span>
                  Licensed by Ministry of Labor Qatar
                </span>
                <span className="hidden xs:flex items-center gap-1">
                  <span className="text-[#154895] font-bold">✓</span>
              ...
              <div className="hidden md:flex items-center text-[11px] sm:text-[12px] font-semibold text-gray-500">
                Qatar · Nepal · International Recruitment
              </div>
            </div>
          </div>
