...
export default function Navbar() {
  ...
  // Measure cert bar height dynamically for all screen sizes
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div
        id="cert-bar"
        className="fixed top-0 left-0 right-0 z-[60] bg-[#154895] text-white"
      >
      ...
      {/* Main Navbar — sits flush below cert bar */}
      <motion.header
      ...
      {/* Mobile menu — also positioned dynamically below both bars */}
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            style={{ top: certBarHeight + 64 }} // cert bar + mobile nav height (h-16)
            className="fixed inset-x-0 z-40 bg-white/95 backdrop-blur-xl border-b border-gray-100 shadow-2xl lg:hidden"
          >
