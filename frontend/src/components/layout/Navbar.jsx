...
const navLinks = [
  ...
  
  {
    ...
    children: [
      ...
      //   href: "/networks", 
      //   icon: Globe,
      //  desc: "Delivering impact globally"
      // },
    ],
  },
            ...
            <div className="flex items-center justify-between h-[60px] sm:h-[68px] lg:h-[72px] gap-2 md:gap-4">
              ...
              <div className="hidden lg:flex items-center flex-shrink-0">
                <a
                  ...
                  className="flex items-center gap-[4px] lg:text-[12px] xl:text-[13px] font-bold text-gray-600 hover:text-[#154895] transition-colors duration-200 px-1 xl:px-3  rounded-[8px] hover:bg-[rgba(21,72,149,0.05)] whitespace-nowrap"
                >
