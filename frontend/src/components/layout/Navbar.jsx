...
/* ── Real Asliya Verification Numbers ── */
const stats = [
...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        {/* max-w container matching custom wrapper with responsive paddings */}
          ...
          <div className="flex items-center justify-between h-[68px] md:h-[76px] gap-2 md:gap-4">
            ...
            >
              <img
                ...
                className="h-9 sm:h-11 md:h-13 lg:h-14 xl:h-16 w-auto object-contain transition-all duration-300"
              />
            </motion.a>

            {/* Live Jobs Badge - Hidden on small laptops (lg) to prevent crowding, returns on xl */}
            <motion.div
            ...
            {/* Desktop Navigation Link Menu - Perfectly scaled for 1024px+ wide displays */}
                  ...
                  <AnimatePresence>
                    {link.children && activeDropdown === link.label && (
                      ...
                      >
                        ...
                        <a href="#services" className="px-4 py-3 bg-[#f8faff] border-t border-gray-100 flex items-center justify-between group/footer hover:bg-[#f2f6ff] transition-colors">
            ...
            {/* Right Action Callouts - Adapts dynamically across all laptops */}
            <motion.div
            ...
            >
              {/* Phone text adapts or collapses based on laptop size */}
              <a
        ...
        {/* Scroll Progress Bottom Bar Trigger */}
        <motion.div
      ...
      <AnimatePresence>
        {mobileOpen && (
          <>
            ...
            >
              {/* Asliya Verified Track Record Panel */}
