...
export default function Services() {
  // ── Read hash on mount to pre-select the right tab ──────────────────────────
  ...
  // Keep tab in sync if user navigates back/forward with hash
  useEffect(() => {
  ...
  // When tab changes via click, update the URL hash silently (no page jump)
